...
public class AdminSearchFilter extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<?> filteredData = (List<?>) request.getAttribute("data");
        ...
        switch (table) {
            ...
            case "corso":
                ...
                filteredData = c.filteredSearchCourse(nomeCategoria, nomeCorso);
                break;
            case "categoria":
            ...
            case "ordine":
                ...
                if (!ordineIdUtenteS.isEmpty())
                    ordineIdUtente = Integer.parseInt(ordineIdUtenteS);
