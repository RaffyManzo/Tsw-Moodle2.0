...
<html>
<head>
    <title>Dashboard di <%= user.getNome()%></title>
...
<div class="header" id="header">
    ...
    <div class="container">
        ...
        <div class="course-container" <%= corsi.isEmpty() ? "style='grid-template-columns: 1fr'" : ""%>>
            ...
            <a href="openCourse?courseID=<%= corso.getIdCorso()%>" class="course-box">
                ...
                <div class='sub-course-info'>
                    <label><%= "Creato il "+ corso.getDataCreazione() %> - <%="Docente: "+  corso.getCreatore().getCognome() + " " + corso.getCreatore().getNome()%></label>
                </div>
            </a>
            <%}
            } else {%>
